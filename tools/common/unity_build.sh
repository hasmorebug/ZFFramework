...
rm "${TARGET_FILE}.tmp" >/dev/null 2>/dev/null
mkdir -p "${TARGET_FILE}.tmp" >/dev/null 2>/dev/null
rm -rf "${TARGET_FILE}.tmp" >/dev/null 2>/dev/null
# ensure file exist
...
mv "${TARGET_FILE}.tmp2" "${TARGET_FILE}.tmp" >/dev/null 2>/dev/null
