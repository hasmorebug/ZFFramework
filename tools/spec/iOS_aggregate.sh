...
COCOAPODS_PROJECT_TRUE_OR_FALSE=FALSE
HEADER_PATH_OR_DUMMY=$PROJ_PATH/src
RES_PATH_OR_DUMMY=$PROJ_PATH/res

sh "$ZF_TOOLS_PATH/spec/iOS/aggregate.sh" $PROJ_NAME "$RELEASE_PATH/module/$PROJ_NAME" "$BUILD_PATH" $COCOAPODS_PROJECT_TRUE_OR_FALSE "$HEADER_PATH_OR_DUMMY" "$RES_PATH_OR_DUMMY"
