...
ZF_SRC_DIRS             += $(ZF_ROOT_PATH)/ZF/ZFCore/src
ZF_SRC_DIRS             += $(ZF_ROOT_PATH)/ZF/ZFAlgorithm/src
ZF_SRC_DIRS             += $(ZF_ROOT_PATH)/ZF/ZFUtility/src
ZF_SRC_DIRS             += $(ZF_ROOT_PATH)/ZF/ZFUIKit/src
ZF_SRC_DIRS             += $(ZF_ROOT_PATH)/ZF/ZFAddition/src
ZF_SRC_DIRS             += $(ZF_ROOT_PATH)/ZF/ZFUIWidget/src
ZF_SRC_DIRS             += $(ZF_ROOT_PATH)/ZF/ZFUIWebKit/src

ZF_SRC_DIRS             += $(ZF_ROOT_PATH)/ZF/ZF_impl/src
ZF_SRC_DIRS             += $(ZF_ROOT_PATH)/ZF/ZF_loader_impl/src
ZF_SRC_DIRS             += $(ZF_ROOT_PATH)/ZF/ZFCore_impl/src
ZF_SRC_DIRS             += $(ZF_ROOT_PATH)/ZF/ZFAlgorithm_impl/src
ZF_SRC_DIRS             += $(ZF_ROOT_PATH)/ZF/ZFUtility_impl/src
ZF_SRC_DIRS             += $(ZF_ROOT_PATH)/ZF/ZFUIKit_impl/src
ZF_SRC_DIRS             += $(ZF_ROOT_PATH)/ZF/ZFAddition_impl/src
ZF_SRC_DIRS             += $(ZF_ROOT_PATH)/ZF/ZFUIWidget_impl/src
ZF_SRC_DIRS             += $(ZF_ROOT_PATH)/ZF/ZFUIWebKit_impl/src
...
ZF_INCLUDES             += $(ZF_ROOT_PATH)/ZF/ZFCore/src
ZF_INCLUDES             += $(ZF_ROOT_PATH)/ZF/ZFAlgorithm/src
ZF_INCLUDES             += $(ZF_ROOT_PATH)/ZF/ZFUtility/src
ZF_INCLUDES             += $(ZF_ROOT_PATH)/ZF/ZFUIKit/src
ZF_INCLUDES             += $(ZF_ROOT_PATH)/ZF/ZFAddition/src
ZF_INCLUDES             += $(ZF_ROOT_PATH)/ZF/ZFUIWidget/src
ZF_INCLUDES             += $(ZF_ROOT_PATH)/ZF/ZFUIWebKit/src

ZF_INCLUDES             += $(ZF_ROOT_PATH)/ZF/ZF_impl/src
ZF_INCLUDES             += $(ZF_ROOT_PATH)/ZF/ZF_loader_impl/src
ZF_INCLUDES             += $(ZF_ROOT_PATH)/ZF/ZFCore_impl/src
ZF_INCLUDES             += $(ZF_ROOT_PATH)/ZF/ZFAlgorithm_impl/src
ZF_INCLUDES             += $(ZF_ROOT_PATH)/ZF/ZFUtility_impl/src
ZF_INCLUDES             += $(ZF_ROOT_PATH)/ZF/ZFUIKit_impl/src
ZF_INCLUDES             += $(ZF_ROOT_PATH)/ZF/ZFAddition_impl/src
ZF_INCLUDES             += $(ZF_ROOT_PATH)/ZF/ZFUIWidget_impl/src
ZF_INCLUDES             += $(ZF_ROOT_PATH)/ZF/ZFUIWebKit_impl/src
