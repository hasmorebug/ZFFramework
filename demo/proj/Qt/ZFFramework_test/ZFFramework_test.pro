...
QMAKE_POST_LINK += $$_ZF_copy_res $$shell_path($$ZF_ROOT_PATH/_release/$$_ZF_QT_TYPE/module/ZFUIWebKit/res) $$_ZF_RES_DEPLOY_PATH $$escape_expand(\\n\\t)
QMAKE_POST_LINK += $$_ZF_install_lib ZFUIWebKit $$shell_path($$ZF_ROOT_PATH/_release/$$_ZF_QT_TYPE/module/ZFUIWebKit/lib) $$_ZF_LIB_DEPLOY_PATH $$escape_expand(\\n\\t)
...
QMAKE_POST_LINK += $$_ZF_copy_res $$shell_path($$ZF_ROOT_PATH/_release/$$_ZF_QT_TYPE/module/ZFUIWebKit_impl/res) $$_ZF_RES_DEPLOY_PATH $$escape_expand(\\n\\t)
QMAKE_POST_LINK += $$_ZF_install_lib ZFUIWebKit_impl $$shell_path($$ZF_ROOT_PATH/_release/$$_ZF_QT_TYPE/module/ZFUIWebKit_impl/lib) $$_ZF_LIB_DEPLOY_PATH $$escape_expand(\\n\\t)
