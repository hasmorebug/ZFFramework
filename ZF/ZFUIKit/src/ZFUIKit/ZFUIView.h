...
protected:
    ...
    virtual inline void layoutOnLayoutRequest(void)
    {
        if(ZFOBSERVER_HAS_ADD(HasAdd_ViewLayoutOnLayoutRequest))
        {
...
private:
    ...
    ZFOBSERVER_HAS_ADD_BEGIN()
        ...
        ZFOBSERVER_HAS_ADD_VALUE(HasAdd_ViewLayoutOnLayoutRequest)
    ...
    ZFOBSERVER_HAS_ADD_SEPARATOR()
        ...
        ZFOBSERVER_HAS_ADD_VALUE_REGISTER(HasAdd_ViewLayoutOnLayoutRequest, ZFUIView::EventViewLayoutOnLayoutRequest())
