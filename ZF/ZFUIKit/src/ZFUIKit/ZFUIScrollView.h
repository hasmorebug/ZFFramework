...
public:
    ...
    {
        return ZFUIRectGetRight(this->scrollContentFrame()) - (this->layoutedFrame().size.width - ZFUIMarginGetX(this->scrollThumbMargin()));
    }
    /** @brief see #scrollContentOffsetLeft */
    virtual inline zfint scrollContentOffsetBottom(void)
    {
        return ZFUIRectGetBottom(this->scrollContentFrame()) - (this->layoutedFrame().size.height - ZFUIMarginGetY(this->scrollThumbMargin()));
    }
