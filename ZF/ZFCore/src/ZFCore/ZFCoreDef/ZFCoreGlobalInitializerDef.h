...
#define _ZFP_ZF_GLOBAL_INITIALIZER_END(Name) \
    ...
    template<typename D> \
    zfclassNotPOD _ZFP_ZFGlobalInitializerAutoInit_##Name \
    { \
    public: \
    ...
    zfclassNotPOD _ZFP_ZFGlobalInitializerAutoInitDummyClass_##Name : _ZFP_ZFGlobalInitializerAutoInit_##Name<_ZFP_ZFGlobalInitializerAutoInitDummyClass_##Name> \
    {};
/**
 * @brief see #ZF_GLOBAL_INITIALIZER_INIT_WITH_LEVEL
 */
