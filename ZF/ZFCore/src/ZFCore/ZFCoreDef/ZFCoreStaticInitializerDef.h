...
#define ZF_STATIC_INITIALIZER_END(Name) \
    ...
    template<typename D> \
    zfclassNotPOD _ZFP_ZFStaticInitializerAutoInit_##Name \
    { \
    public: \
    ...
    zfclassNotPOD _ZFP_ZFStaticInitializerAutoInitDummyClass_##Name : _ZFP_ZFStaticInitializerAutoInit_##Name<_ZFP_ZFStaticInitializerAutoInitDummyClass_##Name> \
    {};
