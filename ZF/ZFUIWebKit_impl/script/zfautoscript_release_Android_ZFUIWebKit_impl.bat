...
call "%ZF_TOOLS_PATH%\common\run_recursive.bat" "%ZF_ROOT_PATH%" "zfautoscript_release_Android_ZFUIWebKit.bat"

call "%ZF_TOOLS_PATH%\common\run_recursive.bat" "%ZF_ROOT_PATH%" "zfautoscript_release_Android_ZF_impl.bat"


call "%ZF_TOOLS_PATH%\spec\Android_release_impl.bat" ZFUIWebKit_impl %WORK_DIR%\..
