...
call "%ZF_TOOLS_PATH%\common\run_recursive.bat" "%ZF_ROOT_PATH%" "zfautoscript_release_Qt_Windows_ZFUIWebKit.bat"

call "%ZF_TOOLS_PATH%\common\run_recursive.bat" "%ZF_ROOT_PATH%" "zfautoscript_release_Qt_Windows_ZF_impl.bat"

call "%ZF_TOOLS_PATH%\spec\Qt_Windows_release.bat" ZFUIWebKit_impl %WORK_DIR%\..
