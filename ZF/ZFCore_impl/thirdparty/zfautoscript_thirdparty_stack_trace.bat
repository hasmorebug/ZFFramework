...
call "%ZF_TOOLS_PATH%\common\copy_check.bat" "%WORK_DIR%\zfautoscript_thirdparty_stack_trace_template.hpp" "%WORK_DIR%\..\src\ZFImpl\_repo\stack_trace\stack.hpp"
call "%ZF_TOOLS_PATH%\common\copy_check.bat" "%WORK_DIR%\zfautoscript_thirdparty_stack_trace_template.cpp" "%WORK_DIR%\..\src\ZFImpl\_repo\stack_trace\stack.cpp"
