 ...
 * @code
 *   cp -rf "relative_path_to_res/." "${CONFIGURATION_BUILD_DIR}/${CONTENTS_FOLDER_PATH}/res/" >/dev/null 2>/dev/null
 * @endcode
 */
...
ZFPROTOCOL_IMPLEMENTATION_BEGIN(ZFFileResProcessImpl_sys_iOS, ZFFileResProcess, ZFProtocolLevelSystemNormal)
public:
    ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFFileResProcessImpl_sys_iOS)(void)
    {
