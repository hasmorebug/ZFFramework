...
call "%ZF_TOOLS_PATH%\common\run_recursive.bat" "%ZF_ROOT_PATH%" "zfautoscript_release_Android_ZFUIWidget.bat"

call "%ZF_TOOLS_PATH%\common\run_recursive.bat" "%ZF_ROOT_PATH%" "zfautoscript_release_Android_ZF_impl.bat"


call "%ZF_TOOLS_PATH%\spec\Android_release_impl.bat" ZFUIWidget_impl %WORK_DIR%\..
