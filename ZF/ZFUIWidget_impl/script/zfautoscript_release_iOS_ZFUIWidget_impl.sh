...
sh "$ZF_TOOLS_PATH/common/run_recursive.sh" "$ZF_ROOT_PATH" "zfautoscript_release_iOS_ZFUIWidget.sh"

sh "$ZF_TOOLS_PATH/common/run_recursive.sh" "$ZF_ROOT_PATH" "zfautoscript_release_iOS_ZF_impl.sh"

sh "$ZF_TOOLS_PATH/spec/iOS_release.sh" ZFUIWidget_impl $WORK_DIR/..
