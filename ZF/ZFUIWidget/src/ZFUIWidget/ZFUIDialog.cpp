...
public:
    ZFLISTENER_MEMBER_DECLARE(dialogClickMaskOnClick)
    {
...
public:
    void layoutDialogPrepare(ZF_IN const ZFUIRect &bounds)
    {
        ...
        {
            this->dialogContainer->layoutParam()->layoutMarginSet(this->owner->dialogBackgroundImage()->imageNinePatch());
        }
    }
...
public:
    _ZFP_ZFUIDialogPrivate *owner;

protected:
    zfoverride
    virtual void layoutOnLayoutPrepare(ZF_IN const ZFUIRect &bounds)
    {
        this->owner->layoutDialogPrepare(bounds);
    }
    zfoverride
    virtual void layoutOnLayout(ZF_IN const ZFUIRect &bounds)
    {
        this->owner->layoutDialog(bounds);
    }
};
...
ZFObject *ZFUIDialog::objectOnInit(void)
{
    ...
    d->dialogClickMask->observerAdd(ZFUIButton::EventButtonOnClick(),
        ZFCallbackForMemberMethod(d, ZFMethodAccessClassMember(_ZFP_ZFUIDialogPrivate, dialogClickMaskOnClick)));
