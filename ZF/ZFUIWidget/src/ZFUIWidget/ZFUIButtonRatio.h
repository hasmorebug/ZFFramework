...
public:
    ...
    {
        propertyValue.to<ZFUIImageView *>()->imageContentSet(ZFUIImageRes(zfText("ZFUIWidget/ZFUIButtonRatio_IconNormal.png")).to<ZFUIImage *>());
    }
    ZFPROPERTY_OVERRIDE_INIT_STEP_DECLARE_RETAIN_NO_AUTO_INIT(ZFUIImageView *, buttonIconStyleHighlighted)
    {
        propertyValue.to<ZFUIImageView *>()->imageContentSet(ZFUIImageRes(zfText("ZFUIWidget/ZFUIButtonRatio_IconHighlighted.png")).to<ZFUIImage *>());
    }
    ZFPROPERTY_OVERRIDE_INIT_STEP_DECLARE_RETAIN_NO_AUTO_INIT(ZFUIImageView *, buttonIconStyleChecked)
    {
        propertyValue.to<ZFUIImageView *>()->imageContentSet(ZFUIImageRes(zfText("ZFUIWidget/ZFUIButtonRatio_IconChecked.png")).to<ZFUIImage *>());
    }
    ZFPROPERTY_OVERRIDE_INIT_STEP_DECLARE_RETAIN_NO_AUTO_INIT(ZFUIImageView *, buttonIconStyleCheckedHighlighted)
    {
        propertyValue.to<ZFUIImageView *>()->imageContentSet(ZFUIImageRes(zfText("ZFUIWidget/ZFUIButtonRatio_IconCheckedHighlighted.png")).to<ZFUIImage *>());
    }
};
