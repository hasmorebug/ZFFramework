...
public:
    ...
    ZFPROPERTY_RETAIN_DETAIL(ZFArrayEditable *, aniFrames,
                             ZFPropertyInitValue(zflineAlloc(ZFArrayEditable)), ZFPropertyNoDefaultValue,
                             protected, protected)
...
protected:
    ...
    {
        if(ZFOBSERVER_HAS_ADD(HasAdd_AniOnStart))
        {
    ...
    {
        if(ZFOBSERVER_HAS_ADD(HasAdd_AniOnStop))
        {
    ...
    {
        if(ZFOBSERVER_HAS_ADD(HasAdd_AniOnRepeat))
        {
    ...
    {
        if(ZFOBSERVER_HAS_ADD(HasAdd_AniOnUpdate))
        {
    ...
    {
        if(ZFOBSERVER_HAS_ADD(HasAdd_AniFrameOnUpdate))
        {
...
private:
    ...
    ZFOBSERVER_HAS_ADD_BEGIN()
        ZFOBSERVER_HAS_ADD_VALUE(HasAdd_AniOnStart)
        ZFOBSERVER_HAS_ADD_VALUE(HasAdd_AniOnStop)
        ZFOBSERVER_HAS_ADD_VALUE(HasAdd_AniOnRepeat)
        ZFOBSERVER_HAS_ADD_VALUE(HasAdd_AniOnUpdate)
        ZFOBSERVER_HAS_ADD_VALUE(HasAdd_AniFrameOnUpdate)
    ZFOBSERVER_HAS_ADD_SEPARATOR()
        ZFOBSERVER_HAS_ADD_VALUE_REGISTER(HasAdd_AniOnStart, ZFUIAnimatedImage::EventAniOnStart())
        ZFOBSERVER_HAS_ADD_VALUE_REGISTER(HasAdd_AniOnStop, ZFUIAnimatedImage::EventAniOnStop())
        ZFOBSERVER_HAS_ADD_VALUE_REGISTER(HasAdd_AniOnRepeat, ZFUIAnimatedImage::EventAniOnRepeat())
        ZFOBSERVER_HAS_ADD_VALUE_REGISTER(HasAdd_AniOnUpdate, ZFUIAnimatedImage::EventAniOnUpdate())
        ZFOBSERVER_HAS_ADD_VALUE_REGISTER(HasAdd_AniFrameOnUpdate, ZFUIAnimatedImage::EventAniFrameOnUpdate())
