...
public:
    ...
    ZFPROPERTY_OVERRIDE_INIT_STEP_DECLARE_RETAIN_NO_AUTO_INIT(ZFUIImageView *, textEditBackgroundView)
    {
        ...
        textEditBackgroundView->imageContentSet(ZFUIImageResXml(zfText("ZFUIWidget/ZFUITextEditWidget_background.xml")).to<ZFUIImage *>());
    }
    ...
    ZFPROPERTY_OVERRIDE_INIT_STEP_DECLARE_RETAIN_NO_AUTO_INIT(ZFUIButtonBasic *, textEditClearButton)
    {
        ...
        textEditClearButton->buttonIconImageSet(ZFUIImageResXml(zfText("ZFUIWidget/ZFUITextEditWidget_clearButton.xml")).to<ZFUIImage *>());
