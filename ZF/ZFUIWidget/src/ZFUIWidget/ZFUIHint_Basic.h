...
public:
    ...
    {
        ZFUIImageView *value = propertyValue.to<ZFUIImageView *>();
        value->imageContentSet(ZFUIImageResXml(zfText("ZFUIWidget/ZFUIHintContentBasic_background.xml")).to<ZFUIImage *>());
    }
