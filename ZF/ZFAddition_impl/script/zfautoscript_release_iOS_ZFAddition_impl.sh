...
sh "$ZF_TOOLS_PATH/common/run_recursive.sh" "$ZF_ROOT_PATH" "zfautoscript_release_iOS_ZFAddition.sh"

sh "$ZF_TOOLS_PATH/common/run_recursive.sh" "$ZF_ROOT_PATH" "zfautoscript_release_iOS_ZF_impl.sh"

sh "$ZF_TOOLS_PATH/spec/iOS_release.sh" ZFAddition_impl $WORK_DIR/..
