...
call "%ZF_TOOLS_PATH%\common\run_recursive.bat" "%ZF_ROOT_PATH%" "zfautoscript_release_Qt_Windows_ZFAddition.bat"

call "%ZF_TOOLS_PATH%\common\run_recursive.bat" "%ZF_ROOT_PATH%" "zfautoscript_release_Qt_Windows_ZF_impl.bat"

call "%ZF_TOOLS_PATH%\spec\Qt_Windows_release.bat" ZFAddition_impl %WORK_DIR%\..
